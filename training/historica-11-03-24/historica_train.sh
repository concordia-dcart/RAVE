...
WORK="$PWD"
NAME="historica_ds2" #name of the training run
RUNS="/project/def-vigliens/tpeschl/runs/historica" #directory where your training run is stored
DATA="/project/def-vigliens/tpeschl/datasets/historica" #directory where audio data is stored
