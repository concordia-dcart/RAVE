...
WORK="$PWD"
NAME="casa_ds2" #name of the training run
RUNS="/project/def-vigliens/tpeschl/runs/casa" #directory where your training run is stored
DATA="/project/def-vigliens/tpeschl/datasets/casa" #directory where audio data is stored
